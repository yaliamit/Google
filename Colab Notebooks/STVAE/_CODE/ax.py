...
def process_args(parser):
    ...
    parser.add_argument('--flow_net',  nargs="*", default=None, help='flow prior net')
    ...
    parser.add_argument('--compare_layers',nargs="*",default=None, help='layers to update')
    ...
    parser.add_argument('--flow_prior',type=int, default=0, help='use a flow prior (default no)')
    ...
    parser.add_argument('--by_class', action='store_true', help='run by each class')
    ...
    parser.add_argument('--classify', type=int, default=None, help='Run Likelihood based classification')
