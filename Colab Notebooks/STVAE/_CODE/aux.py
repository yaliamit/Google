...
def process_args(parser):
    ...
    parser.add_argument('--dec_layers_top',  nargs="*", default=None, help='encoder layer')
    parser.add_argument('--dec_layers_bot',  nargs="*", default=None, help='encoder layer')
    ...
    parser.add_argument('--decoder_nonlinearity', default='relu', help='decoder non_linearity applied to output fully connected matrix on latent layer')
