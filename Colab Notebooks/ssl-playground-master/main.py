...
def main(args):
    ...
    if args.load:
        ...
        trainer = pl.Trainer(default_root_dir=log_dir, max_epochs=args.ssl_epochs, gpus=gpus)
    ...
    trainer = pl.Trainer(max_epochs=args.clf_epochs, gpus=gpus,log_every_n_steps=10)
    trainer.fit(
        classifier,
